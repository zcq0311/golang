...
const OperationStudentDeleteStudent = "/api.helloworld.v1.Student/DeleteStudent"
const OperationStudentGetStudent = "/api.helloworld.v1.Student/GetStudent"
const OperationStudentUpdateStudent = "/api.helloworld.v1.Student/UpdateStudent"

type StudentHTTPServer interface {
	// CreateStudent创建新的学生信息
...
func RegisterStudentHTTPServer(s *http.Server, srv StudentHTTPServer) {
	...
	r.POST("/student/update", _Student_UpdateStudent0_HTTP_Handler(srv))
	r.DELETE("/student/delete/{id}", _Student_DeleteStudent0_HTTP_Handler(srv))
	r.GET("/student/get/{id}", _Student_GetStudent0_HTTP_Handler(srv))
}
